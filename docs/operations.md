...
`onyx-parse-markdown-scope` is centered on parsers work in Ruby. The technical target is: Implement a Ruby parsers project for markdown resource planning, using capacity fixtures and allocation and spill reports.
...
The score is deterministic. The current threshold is 150. Risk has a penalty of 6, latency has a penalty of 4, and weight contributes a bonus of 2.
